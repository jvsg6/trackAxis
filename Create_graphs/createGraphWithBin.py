#!/usr/bin/python2.7
# -*- coding: utf-8 -*-
#Модуль для создания картинок в формате ".png" на основе ".bin" файлов 
#Не доделан, считывает из ".bin", строит картинки, но они не оч красивые =)
#Запуск: 
#1. Запускается модуль createVariationalSeriesFI 
#2. Запускается данный модуль
